...
var regVr22 = "<div><img style='margin-bottom:-4px;' src='/contacts/feedback/load.gif' alt='Отправка...' width='16' height='16'><span style='font: 11px Verdana; color:#333; margin-left:6px;'>Сообщение отправляется...</span></div><br />";
...
$("#send").click(function(){
		...
		$.ajax({
			type: "POST",
			url: "/contacts/feedback/send.php",
		...
		var oll = (messageResp + posSurname + " " + posName + resultStat);
				if(response == 1){
